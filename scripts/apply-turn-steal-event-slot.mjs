...
if (
  ...
  !pageCheck.includes("const turnStealCardDescription =") ||
  !pageCheck.includes('turn-steal-slot-card ${notice.kind ?? "letter"}') ||
...
console.log("Turn steal now renders inside the standard event slot with the exact played-card identity.");